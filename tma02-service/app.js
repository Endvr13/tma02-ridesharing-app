...
class Order {
     ...
     */
    constructor(id, start, end, type, address, userid) {
        this.id = "";
        this.start = new Date();
        this.end = new Date();
        this.type = "";
 ...
 */
app.get(base + "orders/:id", (request, response) => {
 ...
 * @param response  the response object
 */
app.post(base + "orders", (request, response) => {
    response.send(postImp(request.body.userid, request.body.type, request.body.address, request.body.start, request.body.end));
});
/**
 ...
 * @param response  the response object
 */
app.delete(base + "orders/:id", (request, response) => {
 ...
 * @param response  the response object
 */
app.get(base + "matches", (request, response) => {
